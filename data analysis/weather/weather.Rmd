...
adaptation_weather %>% 
  mutate(site = fct_recode(site, 
                           ...
                           "Grant, NE" = "Grant",
                           "Lincoln, NE" = "Lincoln",
                           "Macomb, IL" = "Macomb")) -> adaptation_weather
```
...
adaptation_weather %>% 
  ...
  theme(legend.position = "none",
        ...
        legend.text = element_markdown(size = 25))  -> temp
...
adaptation_weather %>% 
  ...
  mutate(year = as.character(year),
         highlight = ifelse(year %in% c("2018", "2019"), TRUE, FALSE),
         variable = if_else(highlight == TRUE, year, "NA")) -> adaptation_pp
```
...
ggplot(aes(x = month_lab, y = pp)) +
  ...
  geom_richtext(data = text3, aes(x = 2.6, y = 330), lineheight = 0.4, 
            label = "Monthly sum precipitation <br>in <b style='color:red;'>2018</b> and <b style='color:blue;'>2019</b>", size = 6, 
            label.color = NA, fill = NA) +
  geom_richtext(data = text4, aes(x = 3.6, y = 320), lineheight = 0.4, 
            label = "30 years <br>monthly sum <br>precipitation", size = 6, 
             label.color = NA, fill = NA, color = "gray90") +
  ...
  theme(legend.position = "none",
        ...
        axis.title = element_markdown(size = 27),
        axis.text.x = element_markdown(size = 25),
        legend.text = element_markdown(size = 25)) -> ppp
