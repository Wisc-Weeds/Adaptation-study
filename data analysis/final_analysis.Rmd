...
ggplot(month_jun, 
  ...
  labs(x = "Day of year", y = "% cumulative flowering",
       color = NULL) +
  annotate("text", x = 235, y = 1, fontface = "bold",
...
ggsave("figures/figure 3.png", width = 6, height = 6)
```
...
```{r}
(wrap_elements(full = curv1 | curv2)) / wrap_elements(jun2 + jul2) +
   plot_layout(heights = c(1.5, 1.5)) + plot_annotation(tag_levels = 'A')
