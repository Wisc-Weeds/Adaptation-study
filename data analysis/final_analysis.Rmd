...
ggplot(month_jun, 
  ...
  labs(x = "Day of year", y = "% cumulative flowering",
       color = NULL) +
  annotate("text", x = 175, y = 99, fontface = "bold",
           family = "roboto", alpha = 1, size = 3,
           label = "First transplanting", color = "#dadfe1") +
...
ggplot(month_jul, 
  ...
  labs(x = "Day of year", y = "% cumulative flowering",
       title = NULL) +
  theme_test(base_family = "roboto") +
  annotate("text", x = 180, y = 99, fontface = "bold",
           family = "roboto", alpha = 1, size = 3,
           label = "Second transplanting", color = "#dadfe1") +
  scale_color_manual(name = "", 
                    values = c("#30123bFF", 
                               "#fb832d",
                               "#28bbecff"),
...
result3 %>% 
  ...
  mutate(crop = fct_recode(crop,
          ...
          "<b style='color:#fb832d;'>fallow</b>" = "fallow",
...
result %>% 
  ...
  annotate("text", x = 102, y = 1.7, 
            size = 2.5, hjust = 0,
            label = "First transplanting", color = 1) +
  annotate("text", x = 120, y = 2.3, 
            size = 2.5, hjust = 0,
