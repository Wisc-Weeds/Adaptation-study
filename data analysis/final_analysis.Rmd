...
ggplot(iris, aes(Sepal.Length, Sepal.Width, )) +
  geom_emoji(emoji = "2640", color = "red")
```
...
```{r}
data3 %>% 
  ggplot(aes(x = doyh, y = gender_A, color = month, fill = month)) +
  geom_point(alpha = 0.1) +
  geom_emoji(data3 %>% 
               filter(gender == "f"),
             mapping = aes(x = 215, y = 0.95),
             emoji = "2640") +
  geom_emoji(data3 %>% 
               filter(gender == "m"),
             mapping = aes(x = 215, y = 0.05),
             emoji = "2642") +
  ...
  theme(legend.position = "none") -> pl_doyh
#  xlim(175, 270)
...
```{r}
data3 %>% 
  ggplot(aes(x = weight, y = gender_A, color = month, fill = month)) +
  geom_point(alpha = 0.1) +
  geom_emoji(data3 %>% 
               filter(gender == "f"),
             mapping = aes(x = 0.9, y = gender_A),
             emoji = "2640", size = 0.03) +
  geom_emoji(data3 %>% 
               filter(gender == "m"),
             mapping = aes(x = weight, y = gender_A),
             emoji = "2642", size = 0.03) +
  geom_smooth(method = "gam", se = FALSE, stat = "smooth") +
  theme_test(base_family = "roboto") +
  facet_grid(~crop) +
  scale_color_manual(values = c(2,1)) +
  ...
  theme(legend.position = "none") -> pl_weight
#  xlim(175, 270)
...
```{r}
data3 %>% 
  ggplot(aes(x = height, y = gender_A, color = month, fill = month)) +
#  geom_point(alpha = 0.1) +
  geom_emoji(data3 %>% 
               filter(gender == "f"),
             mapping = aes(x = height, y = gender_A),
             emoji = "2640", size = 0.03) +
  geom_emoji(data3 %>% 
               filter(gender == "m"),
             mapping = aes(x = height, y = gender_A),
  ...
  theme(legend.position = "none") -> pl_height
#  xlim(175, 270)
