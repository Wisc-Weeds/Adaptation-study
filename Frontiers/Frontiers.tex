...
Cite fancy references (\textbf{Neuro2013?}). As demonstrated in
(\textbf{Gene2012?}), citations can also be automatically reference.
Multiple references are separated by semicolons (\textbf{Neuro2013?};
\textbf{Neurobot2013?}).
...
\addcontentsline{toc}{subsection}{Plant material}
...
(1 cm) were transplated into 200 cm-3 plastic pots. Palmer amaranth
seedlings supplied with adequate water and kept under greenhouse
conditions at 28/20 C day/night temperature with 80\$ relative humidity.
Artificial lighting was provided using metal halide lamps (600 mmol m-2
s-1) to ensure 15-h photoperiod.

The experiment was conducted under field conditions at five locations:
Arlington, WI (Washington County), Clay Center, NE (Clay County), Grant,
NE (Perkins County), Lincoln, NE (Lancaster County), and Macomb, IL
(McDonough County)
