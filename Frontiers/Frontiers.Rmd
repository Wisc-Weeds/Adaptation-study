...
The study was performed with a *A. palmeri* accession (Per1) from Perkins County, Nebraska. Per1 accession collection is documented in [@oliveira2021a], with no reported herbicide resistance. Seeds were planted in plastic trays containing potting-mix. Emerged seedlings (1 cm) were transplanted into 200 cm<sup>-3</sup> plastic pots (a plant pot<sup>-1</sup>). Palmer amaranth seedlings were supplied with adequate water and kept under greenhouse conditions at Arlington, Clay Center, Lincoln, and Macomb; and kept outdoors in Grant. At 7 to 10 cm height, Palmer amaranth seedlings were transplanted to the field for the onset of the experiment.

## Field study {-}

The experiment was conducted under field conditions at five locations: Arlington (Washington County, Wisconsin), Clay Center (Clay County, Nebraska), Grant (Perkins County, Nebraska), Lincoln (Lancaster County, Nebraska), and Macomb (McDonough County, Illinois)

Palmer amaranth flowering was monitored every other day throughout the study. When a plant started flowering, it was identified as male or female. Plant height was measured from soil surface to the plant apical meristem. Then, aboveground plant biomass was harvest near soil surface and oven dried at 65 C until reaching constant weight before the weight of biomass (g plant<sup>-1</sup>) was recorded.
...
The cumulative Palmer amaranth flowering estimation was determined using a asymetrical three parameter log logistic Weibull function of the drc package . 

$$Y(x) = 0 + (d-0) exp (-exp(b(log(x)-e)))$$
In this model, *Y* is the Palmer amaranth cumulative flowering, *d* is the upper limit (set to 100), and *e* is the XXX, and *x* day of year. 
