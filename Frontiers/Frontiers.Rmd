...
knitr::include_graphics("../weather/Figure 1.png")
```
...
```{r, Figure-2, ref.label = "fig2", echo = FALSE, message = FALSE, fig.height=3, fig.width=6, fig.align='center', fig.cap='Figure caption', out.width = "160mm", out.height = "90mm"}
# You can also refer to code chunks from above to place figures at the bottom.
```
