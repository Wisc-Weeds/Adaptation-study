...
Our study showed the Palmer amaranth adaptation plasticity when growing into different environments. In general,  These result highlight the plant response to grow degree days. 

Palmer amaranth growing plasticity varied within time and space. In general, Palmer amaranth produced more biomass and taller plants when transplanted in early June rather than July. In addition, at first cohort, when resources (e.g., soil nutrients) and conditions (e.g., light) were not limited for both species, Palmer amaranth growing strategy was likely to mimic the cropping systems (Figure 4). In contrast, at second cohort, Palmer amaranth grow and development was limited due to the competitive advantages from the crop, including closed canopy. For example, when growing in corn at first cohort, Palmer amaranth plants accumulated lowest biomass, but produce tallest plants. Higher Palmer amaranth plants in corn is likely the species strategy to compete for light in between corn rows. At first cohort, corn and Palmer amaranth had abundant light over the canopy to grow and develop; however, at second cohort, Palmer amaranth was transplanted when corn canopy was nearly closed, which reduced Palmer amaranth competition. As a result, Palmer amaranth height and biomass was nearly 50% lower compared to its first cohort. 

Similar trend was observed to Palmer amaranth growing in soybeans. The difference in Palmer amaranth height and biomass was lower due to soybean growing strategy. 


Palmer amaranth produced the highest biomass when growing without crop competition (fallow). When growing in fallow, cohort time had low impact on Palmer amaranth growing and development. Moreover, Palmer amaranth biomass was more variable when growing in fallow. 
