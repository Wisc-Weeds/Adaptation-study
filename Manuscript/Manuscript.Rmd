...
Palmer amaranth (*Amaranthus palmeri* S. Watson) is currently considered one of the most economically damaged weed species to cropping systems in the United States . The species has showed a remarkable capacity to evolve resistance to herbicides. To date, Palmer amaranth has evolved resistance to eight herbicide sites of action [@heap2021], increasing the weed management complexity [@lindsay2017]. Unmanaged Palmer amaranth in competition for water, light and nutrients can drastically impact on crop yields [@berger2015]. For example, Palmer amaranth is documented with potential to reduce 91%, 68%, and 54% of corn [@massinga2001], soybean [@klingaman1994], and cotton [@morgan2001] yields, respectively. Thus, Palmer amaranth poses an economical risk to sustainable agriculture.
...
For example, Palmer amaranth growing at first cohort accumulated 90%, 85% and 31% more biomass when compared to second cohort at corn, soybean and fallow, respectively 

In addition, Palmer amaranth growing in corn and soybean at second cohort had a similar end-season flowering pattern.

# Discussion {-}  

Our study showed the Palmer amaranth flowering pattern, grow and development varied within agroecossystems and timing. In general, Palmer amaranth produced more biomass and taller plants when growing at first cohort rather than second cohort. At first cohort, resources (e.g., soil nutrients) and conditions (e.g., light) were more timely available for both species, crop and weed. Thus, Palmer amaranth growing strategy was to mimic the crop species (Figure 4). In contrast, at second cohort, Palmer amaranth grow and development was limited due to the crop competitive ability at advanced development stages. 

Taller Palmer amaranth plants is a possible strategy to compete for light in between crop rows in absence of canopy. For example, at first cohort, corn and Palmer amaranth had abundant light to grow and develop, which also aid its extended the flowering pattern. However, at second cohort, Palmer amaranth was transplanted when corn canopy was nearly closed, which reduced Palmer amaranth competition. As a result, Palmer amaranth height and biomass was nearly 50% and 90% lower compared to its first cohort, respectively. Similar trend was observed to Palmer amaranth growing in soybeans. Palmer amaranth growing without crop competition produced highest amount of biomass. The Palmer amaranth strategy in fallow was to invest biomass in growing plant width and height. Nonetheless, Palmer amaranth produced 31% less biomass in second cohort compared to first cohort timing. Therefore, crop competition was not the only factor limiting Palmer amaranth growing in the second cohort.

It was not evaluate seed production due to Palmer amaranth harvest at early flowering. Nonetheless, it is reported a strong positive correlation between Palmer amaranth biomass and seed production [@schwartz2016; @spaunhorst2018]. I our study, Palmer amaranth growing at first cohort accumulated nearly 50% more overall biomass when compared to second cohort. Therefore, Palmer amaranth plants growing in the second cohort is likely to produce less seeds regardless the agroecossystem. Seed production and deposition in the seedbank is a key factor for species perpetuation [@menges1987]. Palmer amaranth germination is influenced by soil depth and seed viable seeds were fount after 36 months buried in the seedbank [@sosnoskie2013]. Therefore, tactics that promote crop advantage against Palmer amaranth, including early crop planting, preemergence applied herbicide, and crop residue (e.g. cover crops) can minimize the negative impact of Palmer amaranth in agroecossystems.


Palmer amaranth has shown to be responsive to to thermal units (e.g, growing degree days). A study in North Carolina demonstrated that Palmer amaranth emergence in response to soil temperature, with seedlings emerging before July prior to crop canopy closure [@piskackova2021]. In addition, in a bareground study, Palmer emergence emergence pattern in Nebraska was influenced by soil management. Early tillage resulted in 90% Palmer amaranth emergence in June

The higher amount of biomass in the first cohort can also be related to the longer flowering period in the first cohort. In this study, biomass is related to flowering as plant was harvest at early flowering.


can cause significant soybean yield loss [@korres2019]
