...
The cumulative Palmer amaranth flowering estimation was determined using an asymmetrical three parameter log logistic Weibull model of the drc package [@ritz2015].  
...
```{r, Figure-2, ref.label = "fig2", echo = FALSE, message = FALSE, fig.height=3, fig.width=6, fig.align='center', fig.cap='Palmer amaranth adaptation study layout of a transplanting time. Twenty-four Palmer amaranth plants were place 76.2 cm apart in each crop', out.width = "150mm", out.height = "70mm"}
# You can also refer to code chunks from above to place figures at the bottom.
```
